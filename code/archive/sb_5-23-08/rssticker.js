...
document.write('<div id="'+divId+'" class="'+divClass+'" style="float:left;" >Initializing ticker...</div>')
...
*/
var linktitle='<div style="color:#00529b;" class="rsstitle">'+this.title[this.pointer]+'</div>'
var description='<div style="color:#00529b;" class="rssdescription">'+this.description[this.pointer]+'</div>'
var feeddate='<div style="color:#00529b;" class="rssdate">'+this.pubdate[this.pointer]+'</div>'
var spacer='<div style="height:3px;"></div>'
if (this.logicswitch.indexOf("description")==-1) description=""
if (this.logicswitch.indexOf("date")==-1) feeddate=""
var tickercontent=linktitle+spacer+feeddate+spacer+description //STRING FOR FEED CONTENTS 
