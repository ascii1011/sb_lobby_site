        	  ...
        	  .'<td><form action="manage.php" method="post">'
                 ...
                 .'<tr>'
        	         .'<td>'
        		       ...
        		       .'</td>'
        	         .'<td>'
        					 	.'	 &nbsp;<select name="custid">'.CustMultiDimenSelect($cust, 0).'</select>'
        		       .'</td>'
        	         .'<td>'
									 				.'<input type="hidden" name="dest" value="settings" />'
    							 				.' as <input type="submit" name="current" value="current" />'
        		       .'</td>'
        	       .'</tr>'
        			 .'</table></form>'
        		.'</td>'
        		   ...
        		   .'<table border="0"><tr><td><form action="manage.php" method="post">'
                         ...
                         .'<tr>'
                	         .'<td>'
                		       ...
                		       .'</td>'
                	         .'<td>'
                					 	.'<div><input style="width:300px;" value="'.$custedit["image"].'" type="text" name="image" /></div>'
                		       .'</td>'
                	       .'</tr>'
                	       .'<tr>'
                	         .'<td colspan="2">'
